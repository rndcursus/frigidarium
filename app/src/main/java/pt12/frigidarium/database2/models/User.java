 ...
 * this represents a User in the firebase database.
 */
public class User {
    ...
    /**
     * Get the Set of StockIds of the stock this user is in.
     * the key of this map is a random String generated by firebase.
    ...
    /**
     * check if the User exists in the firebaseDatabase.
     * @param uid the uid of the user
     * @param checkExist called after it is known whether the user exists.
     */
